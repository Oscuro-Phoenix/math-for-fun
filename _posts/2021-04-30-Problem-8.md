...
\underlined{P.S.}: If one of the $$n$$ cuts passes through the center of the circle(it'll be a diameter) then the alternate regions are in symmetric w.r.t the diameter. This situation makes the problem very easy and we can say that the white and shaded region have the same area. 
