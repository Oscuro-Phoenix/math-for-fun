...
You can see that the alternate $$sin$$ terms will cancel out from if we sum all the expressions. Only terms remain will include $$R^2$$ only. Finally the area expression is
