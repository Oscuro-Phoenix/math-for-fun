...
A_{BB_1+B\primeB_1\prime}=R^2\theta_0+\frac{1}{2}d^2sin2\theta_0 \\
A_{B_2B_3+B_2\primeB_3\prime}=R^2\theta_0+\frac{1}{2}d^2(sin6\theta_0-sin4\theta_0) \\
\dots 
\\ A_{B_{2m}B_{2m+1}+B_{2m}\primeB_{2m+1}\prime}=R^2\theta_0+\frac{1}{2}d^2(sin(4m+2)\theta_0-sin4m\theta_0) \\
\dots
\\ A_{B_{\frac{n}{2}-(2m+1)}B_{\frac{n}{2}-(2m+2)}+B_{\frac{n}{2}-(2m+1)}\primeB_{\frac{n}{2}-(2m+2)}\prime}=R^2\theta_0+\frac{1}{2}d^2(sin2(\pi-(2m+1)\theta_0)-sin2(\pi-2m\theta_0)) \\
\implies A_{B_{\frac{n}{2}-(2m+1)}B_{\frac{n}{2}-(2m+2)}+B_{\frac{n}{2}-(2m+1)}\primeB_{\frac{n}{2}-(2m+2)}\prime}=R^2\theta_0-\frac{1}{2}d^2(sin2(\pi-(2m+1)\theta_0)-sin2(\pi-2m\theta_0)) 
\dots
