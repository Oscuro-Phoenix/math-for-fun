...
Now let's write down the expressions of area for each white region and it's opposite w.r.t the center. [$$\prime$$ denotes the opposite of a particular region]

$$
A_{BB_1+BB_1\prime}=R^2\theta_0+\frac{1}{2}d^2sin(2\theta_0) \\
A_{B_2B_3+B_2B_3^'}=R^2\theta_0+\frac{1}{2}d^2(sin(6\theta_0)-sin(4\theta_0)) \\
... \\
A_{B_{2m}B_{2m+1}+B_{2m}B_{2m+1}^'}=R^2\theta_0+\frac{1}{2}d^2(sin((4m+2)\theta_0)-sin(4m\theta_0)) \\
... \\
A_{B_{2m}B_{2m+1}+B_{2m}B_{2m+1}^'}=R^2\theta_0+\frac{1}{2}d^2(sin((4m+2)\theta_0)-sin(4m\theta_0)) \\
$$
