...
<center><img style=" display: block; margin-left: auto; margin-right: auto;width: 100%;" src="../assets/Prob8_fig2.png"></center>
...
\overline{PJ}=Rcos(\beta) [\triangle AKJ $$is isosceles$$(\angle AKJ= \angle AJK=\beta)]
$$
...
Now, from the diagram $$\overline{AP}=\overline{AC}sin(\alpha)=dsin(\alpha)$$ and $$\overline{AP}=\overline{AK}sin(\beta)=Rsin(\beta)$$. So we get, 
...
$$
\overline{CK}^2+\overline{CJ}^2=R^2+d^2cos(2\alpha)
$$

Now the area will be 
$$
A_{HCD+CEG}=\int_{0}^{\theta_0} \frac{1}{2} (R^2+d^2cos(2\alpha))\,d\alpha
\implies A_{HCD+CEG}= \frac{1}{2} (R^2\theta_0+\frac{1}{2}d^2sin(2\theta_0))
$$

Similarly 
$$
A_{CFL+CBI}= \frac{1}{2} (R^2\theta_0+\frac{1}{2}d^2(sin(6\theta_0)-sin(4\theta_0))
$$
