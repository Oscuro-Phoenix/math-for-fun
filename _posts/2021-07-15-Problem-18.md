...
$$ L_{i}(\Theta, q) - \log \left(P\left(x_{i} \mid \Theta\right) $$

$$ = \sum_{j=1}^{K} q\left(t_{i}=j\right) \log \left(\frac{P\left(x_{i}, t_{i}=j \mid \Theta\right)}{q\left(t_{i}=j\right)}\right) - \log \left(P\left(x_{i} \mid \Theta\right) $$
