...
$$ L_{i}(\theta, q) - \log \left(P\left(x_{i} \mid \theta\right) = \sum_{j=1}^{K} q\left(t_{i}=j\right) \log \left(\frac{P\left(x_{i}, t_{i}=j \mid \theta\right)}{q\left(t_{i}=j\right)}\right) - \log \left(P\left(x_{i} \mid \theta\right) = \sum_{j=1}^{K} q\left(t_{i}=j\right) \log \left(\frac{P\left(t_{i}=j \mid x_{i}, \theta\right)}{q\left(t_{i}=j\right)}\right) + \sum_{j=1}^{K} q\left(t_{i}=j\right) \log \left(P\left(x_{i} \mid \theta\right) \right) - \log \left(P\left(x_{i} \mid \theta\right) $$
