...
$$ \left\[ \begin{smallmatrix} x_p \\ y_p \end{smallmatrix} \right\] = \left\[ \begin{smallmatrix} x_A & x_B & x_C \\ y_A & y_B & y_C \end{smallmatrix} \right\] .\left\ \begin{smallmatrix} x \\ y \\ z \end{smallmatrix} \right\]  $$
# Proof
