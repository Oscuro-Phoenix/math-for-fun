...
$$
mgy=1/2mv^2
\implies v=k* sqrt(y) where, k=proportionality constant
$$

From Snell's law, 
$$ sin(\theta)/sqrt(y)$$=c(constant) throughout the domain. 

<center><img style=" display: block; margin-left: auto; margin-right: auto;width: 50%;" src="../assets/prob24_fig3.PNG"></center>
...
There is another solution for this problem by Prof. Mark Levi. Check it out [here](https://4ccb06ba-5733-4d01-9652-1f173bc0e51c.filesusr.com/ugd/4d55eb_43090d54f6384c568c2f0f5e116d123f.pdf).

# Reference

1. [The Brachristochrone Problem](https://mathshistory.st-andrews.ac.uk/HistTopics/Brachistochrone/)
2. [Brachristochrone Problem by Wolfram](https://mathworld.wolfram.com/BrachistochroneProblem.html)
