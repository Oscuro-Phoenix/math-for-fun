...
Over 300 years ago, P. Fermat challenged Evangelista Torricelli to find a point within a triangle such that the sum of the distances of it from the vertices of the triangle is minimized.
