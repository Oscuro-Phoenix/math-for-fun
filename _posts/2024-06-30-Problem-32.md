...
This is where my limitations exist. I'm not a genius like Gauss or Euler so I could never have figured this out [See here](https://en.wikipedia.org/wiki/Gauss%27s_continued_fraction). You probably need to spend enough time in the mess to see the patterns emerge but magically a considers $$\Delta = k_i Z f_{i+1}$$ gives an interesting continued fraction recurrence relationship given by,
