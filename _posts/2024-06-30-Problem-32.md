...
$$
\begin{equation}
\frac{F(a+1,b,c+1;Z)}{F(a,b,c;Z)} = \frac{1}{1+\frac{k_1 Z}{\frac{1+\frac{k_2 Z}}{1+\frac{k_3 Z}{1+\dots}}}}
\end{equation}
$$
...
The first thing that comes to do is to see how we could possibly use Gauss's continued fraction formula. In the absence of a better derivation, I'll follow the way it is setup in the paper specifically use the fact 
