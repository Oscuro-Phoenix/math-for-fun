...
Essentially, such a Labyrinth exhibits what many call a "distribution of timescales" that leads to different parts of the system being "felt" in the Nyquist Impedance Diagram when the system is interrogated at different frequencies "\omega".  
