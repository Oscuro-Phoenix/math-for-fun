...
In this post I'll share derivation of a generalized $$ A (j\omega)^{-n} $$ formula detailed in this paper. As always, I will focus on getting a "feel" of the method rather than going through all the steps.
