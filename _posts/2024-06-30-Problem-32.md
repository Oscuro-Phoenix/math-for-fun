...
$$
\begin{equation}
\frac{F(a,b,c;Z)}{F(a+1,b,c+1;Z)} = \frac{1+\frac{k_1 Z}{1+\frac{k_2 Z}{1+\frac{k_3 Z}{1+\dots}}}}
\end{equation}
$$
...
$$
\limit_{h \rightarrow 0} h^n \left(1 + \frac{k_1 Z}{1+\frac{k_2 Z}{1+\frac{k_3 Z}{1+\dots}}} = r_0 + \frac{1}{c_0 z + \frac{1}{r_1 + \frac{1}{c_1 z + \dots}}}
$$
