...
In the second part of our problem the system can be expressed similar to Lorenz' equation by a simple transformation $$D^'=D-(\lambda +1)$$. Which give us,

$$
\dot{E}=\kappa(P-E) \\
\dot{P}=\gamma_1((\lambda +1)E-P-ED^') \\
\dot{D^'}=\gamma_2(\lambda EP-D^') \\
$$
